...
define_generic_procedure_handler(add, any_arg(2, is_symbolic, is_any), lambda a, b: (symbol('+'), a, b))
define_generic_procedure_handler(sub, any_arg(2, is_symbolic, is_any), lambda a, b: (symbol('-'), a, b))
define_generic_procedure_handler(mul, any_arg(2, is_symbolic, is_any), lambda a, b: (symbol('*'), a, b))
define_generic_procedure_handler(div, any_arg(2, is_symbolic, is_any), lambda a, b: (symbol('/'), a, b))
